...
function Footer() {
    return (
        <footer className="bg-secondary/20 dark:bg-gray-900 mt-auto">
            <div className="mx-auto w-full max-w-screen-xl">
                ...
                <div className="px-4 py-6 bg-gray-200 dark:bg-gray-700 md:flex md:items-center md:justify-between">
                    <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2023 <a href="https://flowbite.com/">Esmail™</a>. All Rights Reserved.
                    </span>
